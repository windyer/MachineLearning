...
class IAppPayService(ViewService):
    ...
    def create_charge_order(self, user_id, channel_id, item_id, app_id):
        ...
        charge_log.save()
        transdata={}
        transdata["transid"] = resp["transid"]
        transdata["transtype"] ="1"
        transdata["feetype"] ="1"
        transdata["money"]=1
        transdata["currency"]="1"
        transdata["result"]="1"
        transdata["transtime"]="1"
        transdata["cpprivate"]="1"
        transdata["paytype"]="1"
        self.process_charge_order("1", transdata, 0, "1", app_id)
